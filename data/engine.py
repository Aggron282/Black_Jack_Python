...
class Engine:
    ...
    def quit_game(self):
         if self.player.bank != None:
             self.player.bank.save_money()
         quit();
    ...
    def start_bet(self):
        bet = input(f"How much will you bet? You have ${self.player.bank.get_money():.2f}  \n");
        ...
        can_bet = self.player.bank.set_bet(bet);
